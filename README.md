...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qk3wpa0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qk3wpa0.containers.anotherwebservice.com/
...
```
git clone git@github.com:yousefalagel/container-qk3wpa0.git
cd container-qk3wpa0
```
...
```
docker attach container-qk3wpa0
```
